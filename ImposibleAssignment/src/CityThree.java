...
public class CityThree {
	/**
	 * for easy to update all of the JButton and Panel created as variables of the class
	 */
	JButton buttonHeroPosition1, buttonHeroPosition2, buttonHeroPosition3, btnWest, btnMap;
	...
	public CityThree(GameEnvironment incomingGameE) {
		gameE = incomingGameE;
		initialize();
	}
	...
	public void initialize() {
		...
		btnEast.addActionListener(new ActionListener() {
			 ...
			 * if this button be clicked  it will open home base window and close the city three window
			 */
		...
		btnSouth.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open hospital window and close the city three window
			 */
			public void actionPerformed(ActionEvent e) {
				gameE.PreviousPlace = "CityThree";
				finishedWindow();
				gameE.launchHospital();

			}
		});
		btnSouth.setBounds(367, 749, 349, 38);
		...
		btnWest.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open boss lair window and close the city three window
			 */
			public void actionPerformed(ActionEvent e) {
				gameE.PreviousPlace = "CityThree";
				finishedWindow();
		...
		buttonHeroPosition1.setBounds(292, 238, 161, 142);
		...
		buttonHeroPosition2.setBounds(520, 423, 161, 150);
		...
		buttonHeroPosition3.setBounds(700, 238, 170, 142);
		...
		btnMap.addActionListener(new ActionListener() {
			 ...
			 * and open the map window and save previous place as City three .
			 */
			public void actionPerformed(ActionEvent e) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(CityThree.class.getResource("/img/middle3.png")));
		label.setBounds(472, 214, 210, 201);
		frmCity.getContentPane().add(label);
		
		lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon(CityThree.class.getResource("/img/city3.png")));
