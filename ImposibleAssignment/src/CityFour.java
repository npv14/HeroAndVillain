...
public class CityFour {
	/**
	 * for easy to update all of the JButton and Panel created as variables of the class
	 */
	JButton buttonHeroPosition1, buttonHeroPosition2, buttonHeroPosition3, btnWest, btnMap, btnSouth;
	 ...
	 * @param incomingGameE
	 */
    public CityFour(GameEnvironment incomingGameE) {
		gameE = incomingGameE;
		initialize();
	 ...
	 * if the number of city higher than four then button south will be visible.
	 **/
    public void openWindow() {
    	if(gameE.numberOfCity > 4) {
	...
	public void initialize() {
		...
		btnNorth.addActionListener(new ActionListener() {
			 ...
			 * if this button be clicked  it will open home base window and close the city four window
			 */
		...
		btnEast.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open power up den window and close the city four window
			 * and save Previous Place as city four
			 */
			public void actionPerformed(ActionEvent e) {
				finishedWindow();
				gameE.PreviousPlace = "CityFour";
		...
		btnSouth.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open city 5 window and close the city four window
			 */
			public void actionPerformed(ActionEvent e) {
				finishedWindow();
				gameE.launchCityFive();
			}
		});
		...
		btnWest.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open boss lair window and close the city four window
			 * and save Previous Place as city four
			 */
			public void actionPerformed(ActionEvent e) {
				gameE.PreviousPlace = "CityFour";
		...
		buttonHeroPosition1.setBounds(269, 269, 161, 142);
		...
		buttonHeroPosition2.setBounds(483, 459, 161, 150);
		...
		buttonHeroPosition3.setBounds(697, 269, 170, 142);
		...
		btnMap.addActionListener(new ActionListener() {
			 ...
			 * and open the map window and save previous place as City four .
			 */
			public void actionPerformed(ActionEvent e) {
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(CityFour.class.getResource("/img/middle3.png")));
		label.setBounds(454, 237, 210, 201);
		frmCity.getContentPane().add(label);
		
		lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon(CityFour.class.getResource("/img/city4.png")));
		lblNewLabel.setBounds(1, 0, 1193, 787);
