...
public class Map4City {
	 ...
	 * @param incomingGameE
	 */
	public Map4City(GameEnvironment incomingGameE) {
		gameE = incomingGameE;
		initialize();
	...
	/**
	 * this function call closeMap4City from game Environment to close this window 
	 */
	public void finishedWindow() {
		gameE.closeMap4City(this);
	}
