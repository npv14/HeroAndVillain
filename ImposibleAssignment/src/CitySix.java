...
public class CitySix {
	 ...
	 * @param incomingGameE
	 */
	public CitySix(GameEnvironment incomingGameE) {
		gameE = incomingGameE;
		initialize();
	...
	public void initialize() {
		...
		btnNorth.addActionListener(new ActionListener() {
			 ...
			 * if this button be clicked  it will open boss lair window and close the city six window
			 * and save Previous Place as city six
			 */
			public void actionPerformed(ActionEvent e) {
				gameE.PreviousPlace = "CitySix";
				finishedWindow();
		...
		btnEast.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 *  if this button be clicked  it will open city one window and close the city six window
			 */
			public void actionPerformed(ActionEvent e) {
				finishedWindow();
				gameE.launchCityOne();
		...
		btnWest.addActionListener(new ActionListener() {
			/* (non-Javadoc)
			 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
			 * if this button be clicked  it will open shop window and close the city six window
			 * and save Previous Place as city six
			 */
			public void actionPerformed(ActionEvent e) {
				gameE.PreviousPlace = "CitySix";
		...
		buttonHeroPosition1.setBounds(279, 284, 161, 142);
		...
		buttonHeroPosition2.setBounds(493, 459, 161, 150);
		...
		buttonHeroPosition3.setBounds(705, 284, 170, 142);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon(CitySix.class.getResource("/img/middle1.png")));
		label.setBounds(458, 241, 210, 201);
		frmCity.getContentPane().add(label);
		
		lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon(CitySix.class.getResource("/img/city6.png")));
