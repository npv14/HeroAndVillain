...
public class Map5City {
	 ...
	 * @param incomingGameE
	 */
	public Map5City(GameEnvironment incomingGameE) {
		gameE = incomingGameE;
		initialize();
	...
	/**
	 * this function call closeMap5City from game Environment to close this window 
	 */
	public void finishedWindow() {
		gameE.closeMap5City(this);
	}
